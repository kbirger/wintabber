...
public sealed class AcrylicChrome : WindowChrome
{
    ...
    public bool IsAccentEnabled => AccentState != AccentState.ACCENT_DISABLED;
    ...
    public static readonly DependencyProperty CornerPreferenceProperty = DependencyProperty.Register(
        ...
        typeof(AcrylicChrome),
        new PropertyMetadata(CornerPreference.DWMWCP_DEFAULT));
    ...
    public static void CornerPreferencePropertyChangedCallback(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        if (!(d is AcrylicChrome ch))
            throw new ArgumentException("CompositeChrome type expected");
