...
internal class AccentHelper
{
    ...
    public static void EnableBlur(IntPtr hWnd)
    {
        ...
        Interop.SetAccentPolicy(hWnd, AccentState.ACCENT_ENABLE_BLURBEHIND, AccentFlags.None, hex);
    ...
    public static void EnableBlur(IntPtr hWnd, AccentState accentState, AccentFlags accentFlags, uint hex)
    {
        ...
        Interop.SetAccentPolicy(hWnd, accentState, accentFlags, hex);
    }
    ...
    public static void EnableBlur(IntPtr hWnd, AccentState accentState, uint hex)
    {
        ...
        Interop.SetAccentPolicy(hWnd, accentState, AccentFlags.None, hex);
    }
    ...
    public static void EnableBlur(IntPtr hWnd, AccentFlags accentFlags, uint hex)
    {
        ...
        Interop.SetAccentPolicy(hWnd, AccentState.ACCENT_ENABLE_BLURBEHIND, accentFlags, hex);
    ...
    {
        var hex = (uint)UsingColors.Transparent;
        Interop.SetAccentPolicy(hWnd, AccentState.ACCENT_ENABLE_TRANSPARENTGRADIENT, AccentFlags.None, hex);
    }
    ...
    {
        var hex = (uint)gradientColor;
        Interop.SetAccentPolicy(hWnd, accentState, flags, hex);
    }
